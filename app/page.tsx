    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#f6f4f0' }}>
      ...
      <section style={{ padding: '56px 20px', maxWidth: 960, margin: '0 auto', width: '100%' }}>
        ...
        >
          {[
            {
              quote: "Best bagels I've ever had — and I'm from New York. The everything bagel is unreal.",
              name: 'Sarah M.',
              desc: 'Weekly regular',
            },
            {
              quote: "My kids won't eat any other bagels now. Thanks a lot, Paige.",
              name: 'Mike R.',
              desc: 'Family of 5',
            },
            {
              quote: "I ordered for a brunch party and everyone asked where they came from. 10/10.",
              name: 'Jess T.',
              desc: 'Party host',
            },
            {
              quote: "The sourdough flavor is incredible. You can tell these are made with real starter.",
              name: 'Alex K.',
              desc: 'Sourdough nerd',
            },
            {
              quote: "Ordered the hangover bagels on a Saturday morning. Life-changing decision.",
              name: 'Chris D.',
            ...
            <div
              key={t.name}
              className="flex-shrink-0 snap-center rounded-2xl p-6 flex flex-col justify-between"
              style={{
                flex: '0 0 280px',
                backgroundColor: 'var(--bg-card)',
                border: '1px solid var(--border)',
            ...
            >
              ...
              <p
                className="text-[0.9rem] leading-[1.65] italic mb-5 flex-1"
                style={{ color: '#374151' }}
              >
                &ldquo;{t.quote}&rdquo;
              </p>
              <div>
                <p className="font-bold text-[0.88rem]" style={{ color: 'var(--blue)' }}>
                  {t.name}
                </p>
